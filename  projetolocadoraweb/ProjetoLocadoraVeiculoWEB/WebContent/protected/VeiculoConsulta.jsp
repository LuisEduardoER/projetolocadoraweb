...
<script language="JavaScript">
		...
		function atualizarPanel(form) {
			
			var total = 0;
			
			if (form.checkNavegador.checked) {
				total = 30;
			}
			
			if (form.checkCadeira.checked) {
				total = total + 45;
			}
			
			if (form.checkMotorista.checked) {
				total = total + 30;
			}
			
			form.txtTotalAcessorios.value = "R$ " + total + ",00";
...
<body>
	<form action="fc" method="POST">
		...
		<input type="checkbox" id="Checkbox1" name="checkNavegador" value="on"
			...
			tabindex="1" title="Navegador GPS - R$30,00" onclick="atualizarPanel(this.form)">
		<div id="wb_label"
		...
		<input type="checkbox" id="Checkbox2" name="checkCadeira" value="on"
			...
			tabindex="2" title="Cadeira de bebê - R$45,00"onclick="atualizarPanel(this.form)"> 
		
		<input
			type="checkbox" id="Checkbox3" name="checkMotorista" value="on"
			style="position: absolute; left: 404px; top: 128px; z-index: 5;"
			tabindex="3" title="Motorista - R$30,00" onclick="atualizarPanel(this.form)">
		<div id="wb_label"
			style="position: absolute; left: 429px; top: 129px; width: 158px; height: 16px; z-index: 6;">
			<span style="color: #000000; font-family: Arial; font-size: 13px;">Motorista - R$30,00</span>
		</div>
		<div id="wb_label"
		...
		<input type="text" id="txtTotalAcessorios_ID"
			...
			name="txtTotalAcessorios" value="" tabindex="4" disabled="disabled"
		...
		<table
			...
			<%
				  	...
				  	for(int i = 0; i < grupos.size() ; i++){
						...
						for (int j = 0; j < grupo.getListaDeVeiculos().size() ; j++) {
							...
							%>
			<tr align="center">
				<td width="10px" class="tdDados"><input type="radio"
					name="item" checked="checked"
			...
			<tr>
				<td colspan="13" style="width: 1037px; ">
					<input type="button" id="botao_ID" name="btnVoltar" value="Voltar" style="position: absolute; left: 201px; top: 479px; width: 96px; height: 25px; z-index: 10;" tabindex="5" title="Voltar" onclick="executar(this.form,'voltarVeiculo')">
					<input type="submit" id="botao_ID" name="btnConsultar" value="Consultar" style="position: absolute; left: 333px; top: 479px; width: 96px; height: 25px; z-index: 11;" tabindex="6" title="Consultar">
					<input type="button" id="botao_ID" name="btnIncluir" value="Incluir" style="position: absolute; left: 465px; top: 479px; width: 96px; height: 25px; z-index: 12;" tabindex="7" title="Incluir" onclick="executar(this.form,'incluirVeiculo')">
					<input type="button" id="botao_ID" name="btnDetalhes" value="Detalhes" style="position: absolute; left: 597px; top: 479px; width: 96px; height: 25px; z-index: 13;" tabindex="8" title="Detalhes" onclick="executar(this.form,'detalhesVeiculo')">
					<input type="button" id="botao_ID" name="btnEscolher" value="Escolher" style="position: absolute; left: 729px; top: 479px; width: 96px; height: 25px; z-index: 14;" tabindex="9" title="Escolher" onclick="executar(this.form,'escolherVeiculo')">
				</td>
			</tr>
		</table>
