...
<body>
	<input type="radio" id="checkPessoaFisica_id" name="" value="on"
		style="position: absolute; left: 320px; top: 100px; z-index: 0;">
	<input type="radio" id="checkPessoaJuridica_id" name="" value="on"
	...
	<div id="wb_txtPessoaFisica_id"
		...
		<span style="color: #000000; font-family: Arial; font-size: 13px;">Pessoa
			Física</span>
	</div>
	...
	<input type="submit" id="btnVoltar_id" name="" value="Voltar"
		style="position: absolute; left: 250px; top: 200px; width: 96px; height: 25px; z-index: 4;">
