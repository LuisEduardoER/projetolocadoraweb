...
<html>
	...
	<title>Veículos - Alteração</title>
	<style type="text/css">
	body {
	...
	#txtTarifaControlada_id {
		...
		<form action="fc" method="POST">
			...
			<input type="text" id="txtModelo_id"
				...
				name="txtModelo" value="<jsp:getProperty name='veiculoSelecionado' property='modelo' />" tabindex="1"
			...
			<input type="text" id="txtFabricante_id"
				...
				name="txtFabricante" value="<jsp:getProperty name='veiculoSelecionado' property='fabricante' />" tabindex="2" 
			...
			<input type="text" id="txtChassi_id"
				...
				name="txtChassi" value="<jsp:getProperty name='veiculoSelecionado' property='chassi' />" tabindex="3" 
			...
			<input type="text" id="txtPlaca_id"
				...
				name="txtPlaca" value="<jsp:getProperty name='veiculoSelecionado' property='placa' />" tabindex="4" 
			...
			<input type="text" id="txtKM_id"
				...
				name="txtKM" value="<jsp:getProperty name='veiculoSelecionado' property='km' />" tabindex="5" 
			...
			<input type="text" id="txtCidade_id"
				...
				name="txtCidade" value="<jsp:getProperty name='veiculoSelecionado' property='cidade' />" tabindex="6" 
			...
			<input type="text" id="txtEstado_id"
				...
				name="txtEstado" value="<jsp:getProperty name='veiculoSelecionado' property='estado' />" tabindex="7" 
