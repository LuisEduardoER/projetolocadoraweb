//Classe ClienteConsultaDetPJView
package View;
...
public class ClienteConsultaDetPJView extends ClienteDadosPJView{
...
//	BOTÕES
	...
	public ClienteConsultaDetPJView(){
		super();
		desabilitarCampos();
		addBotoes();
		montaJFrame(Idioma.bn.getString("clienteConsultaDetPJView.title"));
	}
